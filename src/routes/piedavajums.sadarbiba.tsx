      ...
      <div className="grid gap-12 lg:grid-cols-2">
        ...
        <div>
          <p className="text-muted-foreground">
            Ja Jūsu izstādē ir svarīgi īpaši izcelt nozīmīgus klientus, sadarbības partnerus vai
            komandas locekļus, standarta dāvanas vietā tiem var pievienot kvalitatīvākas un
            personiskākas dāvanas, kas izceļ uzņēmuma attieksmi, pateicību un vēlmi veidot
            ilgtermiņa sadarbību.
          </p>
          <p className="mt-4 text-muted-foreground">
            Ja nepieciešams, šo pieeju var pievienot galvenajam izstādes risinājumam.
          </p>
